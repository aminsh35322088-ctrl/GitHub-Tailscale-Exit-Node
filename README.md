...
| مورد | مقدار |
| :--- | :--- |
| وضعیت اجرا | 🟡 در حال پایان یا تعویض اجرا |
| آخرین بررسی | 2026-09-22 17:16:58 UTC |
| نام تنظیم‌شده | `GitHub-Exit` |
| شروع مرحلهٔ نگهداری | — |
| زمان سپری‌شده تا این بررسی | — |
| تعویض تقریبی | — |
| جزئیات اجرا | [مشاهده](https://github.com/aminsh35322088-ctrl/GitHub-Tailscale-Exit-Node/actions/runs/35757471780) |
