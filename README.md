...
| آخرین بررسی | 2026-09-22 05:05:15 UTC |
| نام تنظیم‌شده | `GitHub-Exit` |
| شروع مرحلهٔ نگهداری | 2026-09-22 04:02:37 UTC |
| زمان سپری‌شده تا این بررسی | 62 دقیقه |
| تعویض تقریبی | 2026-09-22 09:32:37 UTC |
| جزئیات اجرا | [مشاهده](https://github.com/aminsh35322088-ctrl/GitHub-Tailscale-Exit-Node/actions/runs/35663149926) |
